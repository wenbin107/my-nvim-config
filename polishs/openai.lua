...
```
require('openai').stream("What is the meaning of life?", { trim_leading = true, -- Trim leading whitespace of the response
...
M.stream = function(prompt_or_messages, opts)
	if vim.g.gpt_api_key == nil then
		print("Please provide an OpenAI API key require('openai').setup({})")
		return
	end
	...
	local model = opts.model or "glm-4-flash"
...
--header 'Authorization: Bearer b5102e32dfef8cda86fae1e1f7d1e19b.7N0ol6a0tcciBxaM' \
